...
export class PopoverRef<T = any> {
   ...
   constructor(
      ...
      if (
         ...
         overlayRef.backdropElement.parentElement &&
         overlayRef.backdropElement.parentElement.parentElement
      ) {
         overlayRef.backdropElement.parentElement.parentElement.style.zIndex = "1002";
      }
